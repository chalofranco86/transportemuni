<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('nombre_vehi', $vehi->nombre_vehi, ['class' => 'form-control' . ($errors->has('nombre_vehi') ? ' is-invalid' : ''), 'placeholder' => 'Nombre Vehi']) }}
            {!! $errors->first('nombre_vehi', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('placa_vehi') }}
            {{ Form::text('placa_vehi', $vehi->placa_vehi, ['class' => 'form-control' . ($errors->has('placa_vehi') ? ' is-invalid' : ''), 'placeholder' => 'Placa Vehi']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('tipo_vehi', $vehi->tipo_vehi, ['class' => 'form-control' . ($errors->has('tipo_vehi') ? ' is-invalid' : ''), 'placeholder' => 'Tipo Vehi']) }}

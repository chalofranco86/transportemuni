...
namespace App\Http\Controllers;
    ...
    class CardController extends Controller
    {
        ...
        {
            $cards = Card::where('estado_card', 'SOLICITADA')->get();
            return view('card.solicitudes', compact('cards'));
        }
        ...
        public function solicitar($id)
        {
            $card = Card::find($id);
            if ($card) {
                $card->estado_card = 'SOLICITADA';
                $card->save();
            }

            return redirect()->route('cards.show', $id)->with('success', 'La tarjeta ha sido solicitada.');
        }
    }
